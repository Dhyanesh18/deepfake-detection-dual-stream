...
class DeepfakeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Still return DCT to keep shape, but ignore later
...
def train_epoch(model, dataloader, criterion, optimizer, device):
    ...
    for rgb, _, labels in tqdm(dataloader, desc='Train Baseline ResNet', leave=False):
        # Ignore DCT input
...
def main():
    ...
    SAVE_DIR = 'trained_baseline_resnet'
    ...
    print("Initializing Baseline ResNet18...")
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), f'{SAVE_DIR}/baseline_resnet.pth')
